...
class FluxAnalytics(
    ...
    fun searchResultClick(videoId: String, title: String) = track("search_result_click", mapOf("video_id" to videoId, "title" to title))
    fun trackPlay(trackId: String, title: String) = track("track_play", mapOf("track_id" to trackId, "title" to title))
    ...
    fun videoPlay(videoId: String, title: String) = track("video_play", mapOf("video_id" to videoId, "title" to title))
    fun wishlistAdd(videoId: String, title: String) = track("wishlist_add", mapOf("video_id" to videoId, "title" to title))
    ...
    fun movieOpen(movieId: String, title: String) = track("movie_open", mapOf("movie_id" to movieId, "title" to title))
    fun login(email: String) = track("login", mapOf("email_domain" to (email.substringAfter("@", "unknown"))))
    fun logout() = track("logout")

    private fun track(name: String, params: Map<String, Any> = emptyMap()) {
