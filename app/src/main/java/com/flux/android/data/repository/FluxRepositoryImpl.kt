...
class FluxRepositoryImpl(
    ...
    override suspend fun getTrending(region: String): Resource<List<MusicTrack>> =
    ...
    override suspend fun getGenreMusic(genreType: String): Resource<List<MusicTrack>> =
        withContext(Dispatchers.IO) {
    ...
    override suspend fun getMovies(): Resource<List<MovieItem>> =
        withContext(Dispatchers.IO) {
            val cacheKey = "movies"
            try {
    ...
    override suspend fun getWishlist(): Resource<List<WishlistItem>> =
        withContext(Dispatchers.IO) {
            try {
    ...
    override suspend fun addToWishlist(track: MusicTrack): Resource<WishlistItem> =
        withContext(Dispatchers.IO) {
    ...
    override suspend fun removeFromWishlist(idOrVideoId: String): Resource<Unit> =
        withContext(Dispatchers.IO) {
    ...
    override suspend fun getStreamUrl(videoId: String): Resource<String?> =
        withContext(Dispatchers.IO) {
            try {
    ...
    private fun getCachedOrFallbackTrending(
        region: String,
        errorMessage: String,
    ): Resource<List<MusicTrack>> {
    ...
    @Suppress("UNCHECKED_CAST")
    private fun getCachedOrFallbackGenre(
        genre: String,
        errorMessage: String,
    ): Resource<List<MusicTrack>> {
            ...
            if (region == "IN") {
                listOf(
                    MusicTrack(
                        ...
                        "Tauba Tauba",
                        "Karan Aujla, Badshah",
                        "https://i.ytimg.com/vi/k4yXQkG2s1E/hqdefault.jpg",
                        "3:28",
                    ),
                    MusicTrack(
                        "kJQP7kiw5Fk",
                        "Despacito (Indian Remix)",
                        "Luis Fonsi, Badshah",
                    ...
                    MusicTrack(
                        "7zp1TbLFPXA",
                        "Chaleya",
                        "Arijit Singh, Anirudh",
                        "https://i.ytimg.com/vi/7zp1TbLFPXA/hqdefault.jpg",
                        "3:20",
                    ),
                    MusicTrack(
                        "G_r36oK0YgQ",
                        "Illuminati",
                        "Sushin Shyam, Dabzee",
                        "https://i.ytimg.com/vi/G_r36oK0YgQ/hqdefault.jpg",
                        "2:46",
                    ),
                    ...
                    MusicTrack(
                        "5GL9JoH4Sws",
                        "Soulmate",
                        "Badshah, Arijit Singh",
                        "https://i.ytimg.com/vi/5GL9JoH4Sws/hqdefault.jpg",
                        "3:34",
                    ),
                    MusicTrack(
                        "JFcgOboQZ08",
                        "Dheere Dheere",
                        "Yo Yo Honey Singh",
                        "https://i.ytimg.com/vi/JFcgOboQZ08/hqdefault.jpg",
                        "3:32",
                    ),
                )
            } else {
                listOf(
                    ...
                    MusicTrack(
                        ...
                        "Sugar",
                        "Maroon 5",
                        "https://i.ytimg.com/vi/09R8_2nJtjg/hqdefault.jpg",
                        "3:55",
                        isVideo = true,
                    ),
                    MusicTrack(
        ...
        val movies =
            listOf(
                MovieItem(
                    ...
                    "https://i.ytimg.com/vi/TcMBFSGVi1c/hqdefault.jpg",
                    "Marvel Studios",
                    "2:26",
                    "2019",
                ),
                MovieItem(
                    ...
                    "https://i.ytimg.com/vi/EXeTwQWrcwY/hqdefault.jpg",
                    "Warner Bros.",
                    "2:30",
                    "2008",
                ),
                MovieItem(
                    ...
                    "https://i.ytimg.com/vi/zSWdZVtXT7E/hqdefault.jpg",
                    "Paramount Pictures",
                    "2:32",
                    "2014",
                ),
                ...
                MovieItem(
                    ...
                    "https://i.ytimg.com/vi/uYPbbksJxIg/hqdefault.jpg",
                    "Universal Pictures",
                    "3:06",
                    "2023",
                ),
